...
import CarIcon from "../../../assets/icons/icons8-car-64.png"; // replace with your icons/images
import TrustIcon from "../../../assets/icons/icons8-trust-64.png"; // reused or replace with a "trust" icon
  ...
  return (
    <section className="w-full bg-[#f6f7f9] py-28 px-20">
      ...
      <div className="text-center mb-16">
        <h2 className="text-5xl font-bold text-[#171b25] mb-4">About Motary</h2>
