      ...
      <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="flex items-center gap-2 mb-2">
            <FaEnvelope /> <a href="mailto:info@motary.com" className="hover:text-[#e35b25] transition-colors">info@motary.com</a>
          </div>
          <div className="flex items-center gap-2 mb-2">
            <FaPhone /> <a href="tel:+212600000000" className="hover:text-[#e35b25] transition-colors">+212 600 000 000</a>
          </div>
          <div className="flex items-center gap-2">
            <FaMapMarkerAlt /> <span>Casablanca, Morocco</span>
          </div>
        </div>
